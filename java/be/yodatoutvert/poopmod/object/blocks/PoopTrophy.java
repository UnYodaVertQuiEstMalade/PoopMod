...
public class PoopTrophy extends Block implements IHasModel
{
    public PoopTrophy(String name, net.minecraft.block.material.Material material)
    {
        super(material);
    ...
    protected static final AxisAlignedBB AXIS_ALIGNED_BB = new AxisAlignedBB(0.25D, 0.0D, 0.25D, 0.75D, 0.75D, 0.75D);
